...
var germanMessages = {
    ra: {
        ...
        message: {
            ...
            bulk_update_title: 'Aktualisiere %{name} |||| Aktualisiere %{smart_count} %{name} Elemente',
            delete_content: 'Möchten Sie diesen Inhalt wirklich löschen?',
            delete_title: 'Lösche %{name} #%{id}',
            details: 'Details',
            error: 'Beim Laden der Seite ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.',
            invalid_form: 'Das Formular enthält ungültige Daten. Bitte korrigieren Sie diese.',
            loading: 'Die Seite wird geladen. Bitte warten Sie, bis die Seite vollständig geladen ist.',
            no: 'Nein',
        ...
        validation: {
            ...
            minValue: 'Bitte geben Sie einen Wert größer oder gleich {minValue} ein',
            maxValue: 'Bitte geben Sie einen Wert kleiner oder gleich {maxValue} ein',
            number: 'Bitte geben Sie eine Zahl ein',
            email: 'Bitte geben Sie eine gültige E-Mail-Adresse ein',
            oneOf: 'Bitte wählen Sie einen der folgenden Werte aus: {values}',
            regex: 'Bitte geben Sie einen Wert ein, der dem Muster "{regex}" entspricht',
        },
        saved_queries: {
            label: 'Meine Anfragen',
            query_name: 'Name der Anfrage',
            new_label: 'Zu meinen Anfragen hinzufügen...',
            new_dialog_title: 'Die aktuelle Anfrage zu meinen Anfragen hinzufügen',
            remove_label: 'Aus meinen Anfragen entfernen',
            remove_label_with_name: '"%{name}" aus meinen Suchanfragen entfernen',
            remove_dialog_title: 'Aus meinen Suchanfragen löschen?',
            remove_message: 'Sind Sie sicher, dass Sie diese Anfrage aus Ihrer Anfrageliste entfernen möchten?',
            help: 'Filtern Sie die Liste und fügen Sie diese Anfrage zu Ihrer Liste hinzu',
        },
    },
};
exports.default = germanMessages;
